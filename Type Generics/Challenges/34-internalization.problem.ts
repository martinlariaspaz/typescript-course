...
const translate = <
  ...
  TTKey extends keyof TTranslation,
  TParamsKeys extends string[] = GetParamKeys<TTranslation[TTKey]>
>(
  translations: TTranslation,
  key: TTKey,
  ...args: TParamsKeys extends []
    ? []
    : [params: Record<TParamsKeys[number], string>]) => {
